...
snapshot: lts-22.44
```
2. Add the extra dependency to ForSyDe-Atom. Here we use an unofficial version that has been developed for the newer GHC version (9.6.7). You can add it at the end of the file.
